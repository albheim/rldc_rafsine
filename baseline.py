...
analysis = tune.run(
    ...
    config={
        ...
        "env_config": {
            ...
            "place_load_indices": tune.grid_search([range(360), range(0, 180), range(0, 360, 2)])
        },
    ...
    local_dir=os.path.join("results", "DCEnv", "RAFSINE" if args.rafsine else "SIMPLE", "BASELINE", args.model),
