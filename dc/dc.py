...
class DCEnv(gym.Env):
    def __init__(self, config={}):
        ...
        action_spaces_agent = {
            ...
            "crah_temp_out": gym.spaces.Box(-1, 1, shape=(1,)),
        ...
        observation_spaces = {
            "server_load": gym.spaces.Box(-100, 100, shape=(self.n_servers,)),
            "server_temp_out": gym.spaces.Box(-100, 100, shape=(self.n_servers,)),
        ...
        self.observation_spaces_agent = {
            "server_load": gym.spaces.Box(-1, 1, shape=(self.n_servers,)),
            "server_temp_out": gym.spaces.Box(-1, 1, shape=(self.n_servers,)),
